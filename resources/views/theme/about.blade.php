                                ...
                                <div class="team-member u-h-100">
                                    <div class="team-member__wrap">
                                        <div class="aspect aspect--bg-grey-fb aspect--square">
                                            ...
                                            <img class="aspect__img team-member__img" src="{{asset('assets')}}/images/about/member-1.jpg" alt=""></div>
                                ...
                                <div class="team-member u-h-100">
                                    <div class="team-member__wrap">
                                        <div class="aspect aspect--bg-grey-fb aspect--square">
                                            ...
                                            <img class="aspect__img team-member__img" src="{{asset('assets')}}/images/about/member-2.jpg" alt=""></div>
                                        <div class="team-member__social-wrap">
                                            <ul class="team-member__social-list">
                                                <li>
                                ...
                                <div class="team-member u-h-100">
                                    <div class="team-member__wrap">
                                        <div class="aspect aspect--bg-grey-fb aspect--square">
                                            ...
                                            <img class="aspect__img team-member__img" src="{{asset('assets')}}/images/about/member-3.jpg" alt=""></div>
                                        <div class="team-member__social-wrap">
                                            <ul class="team-member__social-list">
                                                <li>
                                ...
                                <div class="team-member u-h-100">
                                    <div class="team-member__wrap">
                                        <div class="aspect aspect--bg-grey-fb aspect--square">
                                            ...
                                            <img class="aspect__img team-member__img" src="{{asset('assets')}}/images/about/member-4.jpg" alt=""></div>
                                        <div class="team-member__social-wrap">
                                            <ul class="team-member__social-list">
                                                <li>
