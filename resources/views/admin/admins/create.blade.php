                            ...
                            <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                <div class="dash__pad-2">
                                    ...
                                    <form class="dash-address-manipulation" method="POST" action="{{ route('admin.admin.store') }}">
                                        ...
                                        <button class="btn btn--e-brand-b-2" style="background-color: #7737de; color: white; border: 2px solid #7737de;  transition: all 0.3s ease;" onmouseover="this.style.backgroundColor='#6b2fcc'; this.style.borderColor='#6b2fcc';" onmouseout="this.style.backgroundColor='#7737de'; this.style.borderColor='#7737de';" type="submit">Add</button>
                                    </form>
                                </div>
                            </div>
                        </div>
